...
function valueType(parameterOne, parameterTwo){
  if(typeof parameterOne == typeof parameterTwo && parameterOne == parameterTwo){
    return "Exactly the same";
  } else if (typeof parameterOne != typeof parameterTwo && parameterOne == parameterTwo){
...
var promiseCatcher = function(parameter){
